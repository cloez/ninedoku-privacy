...
import 'tents_badge_definitions.dart';

/// 텐트 배지 서비스 -- 달성 평가 및 저장
class TentsBadgeService {
  static const _keyAcquiredBadges = 'tents_acquired_badges';
  final SharedPreferences _prefs;

  TentsBadgeService(this._prefs);
  ...
  List<BadgeDefinition> evaluateNewBadges(List<CompletedGameRecord> records) {
    ...
    for (final badge in tentsBadgeDefinitions) {

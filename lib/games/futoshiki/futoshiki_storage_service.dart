...
/// 후토시키 완료 기록 저장/조회 서비스 (SharedPreferences + JSON)
class FutoshikiStorageService {
  static const _keyCompletedGames = 'futoshiki_completed_games';

  final SharedPreferences _prefs;

  FutoshikiStorageService(this._prefs);

          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppStrings.get('futoshiki.subtitle'),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(AppStrings.get('futoshiki.newGame')),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(AppStrings.get('futoshiki.dailyPuzzle')),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text(AppStrings.get('futoshiki.statistics')),
                      ),
                    ),
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text(AppStrings.get('futoshiki.badges')),
                      ),
                    ),
                  ],
                ),
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    AppStrings.get('futoshiki.continue'),
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                          fontWeight: FontWeight.bold,
                        ),
                  ),
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppStrings.get('futoshiki.about.title'),
              style: TextStyle(
                fontSize: 15,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            Text(
              AppStrings.get('futoshiki.about.desc'),
              style:
                  TextStyle(fontSize: 13, color: bodyColor, height: 1.5),
            ),
            const SizedBox(height: 16),
            Text(
              AppStrings.get('futoshiki.rules.title'),
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            _ruleRow('1', AppStrings.get('futoshiki.rules.r1'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('2', AppStrings.get('futoshiki.rules.r2'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('3', AppStrings.get('futoshiki.rules.r3'), ruleColor),
          ],
        ),
      ),
    );

...
import 'kakuro_badge_definitions.dart';

/// 카쿠로 배지 서비스 — 달성 평가 및 저장
class KakuroBadgeService {
  static const _keyAcquiredBadges = 'kakuro_acquired_badges';
  final SharedPreferences _prefs;

  KakuroBadgeService(this._prefs);
  ...
  List<BadgeDefinition> evaluateNewBadges(List<CompletedGameRecord> records) {
    ...
    for (final badge in kakuroBadgeDefinitions) {

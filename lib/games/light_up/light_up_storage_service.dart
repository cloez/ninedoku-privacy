...
/// 라이트업 완료 기록 저장/조회 서비스 (SharedPreferences + JSON)
class LightUpStorageService {
  static const _keyCompletedGames = 'lightup_completed_games';

  final SharedPreferences _prefs;

  LightUpStorageService(this._prefs);

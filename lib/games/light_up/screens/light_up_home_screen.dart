          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppStrings.get('lightUp.subtitle'),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(AppStrings.get('lightUp.newGame')),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(AppStrings.get('lightUp.dailyPuzzle')),
                ...
                Row(
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        onPressed: () => context.push(AppRoutes.statistics, extra: 'lightUp'),
                        icon: const Icon(Icons.bar_chart_rounded, size: 20),
                        label: Text(AppStrings.get('lightUp.statistics')),
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: OutlinedButton.icon(
                        onPressed: () => context.push(AppRoutes.badges, extra: 'lightUp'),
                        icon: const Icon(Icons.emoji_events_rounded, size: 20),
                        label: Text(AppStrings.get('lightUp.badges')),
                      ),
                    ),
                  ],
                ),
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    AppStrings.get('lightUp.continue'),
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                          fontWeight: FontWeight.bold,
                        ),
                  ),
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppStrings.get('lightUp.about.title'),
              style: TextStyle(
                fontSize: 15,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            Text(
              AppStrings.get('lightUp.about.desc'),
              style: TextStyle(fontSize: 13, color: bodyColor, height: 1.5),
            ),
            const SizedBox(height: 16),
            Text(
              AppStrings.get('lightUp.rules.title'),
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            _ruleRow('1', AppStrings.get('lightUp.rules.r1'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('2', AppStrings.get('lightUp.rules.r2'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('3', AppStrings.get('lightUp.rules.r3'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('4', AppStrings.get('lightUp.rules.r4'), ruleColor),
          ],
        ),
      ),
    );

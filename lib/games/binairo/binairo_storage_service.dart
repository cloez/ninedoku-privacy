...
/// 비나이로 완료 기록 저장/조회 서비스 (SharedPreferences + JSON)
class BinairoStorageService {
  static const _keyCompletedGames = 'binairo_completed_games';

  final SharedPreferences _prefs;

  BinairoStorageService(this._prefs);

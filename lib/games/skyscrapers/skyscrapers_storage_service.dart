...
/// Skyscrapers 완료 기록 저장/조회 서비스 (SharedPreferences + JSON)
class SkyscrapersStorageService {
  static const _keyCompletedGames = 'skyscrapers_completed_games';

  final SharedPreferences _prefs;

  SkyscrapersStorageService(this._prefs);

          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppStrings.get('skyscrapers.subtitle'),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(AppStrings.get('skyscrapers.newGame')),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(AppStrings.get('skyscrapers.dailyPuzzle')),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text(AppStrings.get('skyscrapers.statistics')),
                      ),
                    ),
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text(AppStrings.get('skyscrapers.badges')),
                      ),
                    ),
                  ],
                ),
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    AppStrings.get('skyscrapers.continue'),
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                          fontWeight: FontWeight.bold,
                        ),
                  ),
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppStrings.get('skyscrapers.about.title'),
              style: TextStyle(
                fontSize: 15,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            Text(
              AppStrings.get('skyscrapers.about.desc'),
              style:
                  TextStyle(fontSize: 13, color: bodyColor, height: 1.5),
            ),
            const SizedBox(height: 16),
            Text(
              AppStrings.get('skyscrapers.rules.title'),
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            _ruleRow('1', AppStrings.get('skyscrapers.rules.r1'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('2', AppStrings.get('skyscrapers.rules.r2'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('3', AppStrings.get('skyscrapers.rules.r3'), ruleColor),
          ],
        ),
      ),
    );

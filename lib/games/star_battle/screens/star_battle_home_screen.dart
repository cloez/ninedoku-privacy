...
class _StarBattleHomeScreenState extends ConsumerState<StarBattleHomeScreen> {
  ...
  void _showNewGameWarning(BuildContext context) {
    showKPDialog(
      context: context,
      title: AppStrings.get('starBattle.newGame.warning.title'),
      content: AppStrings.get('starBattle.newGame.warning.message'),
      confirmLabel: AppStrings.get('starBattle.newGame.warning.confirm'),

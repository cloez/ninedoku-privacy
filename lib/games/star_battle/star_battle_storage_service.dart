...
/// 스타 배틀 완료 기록 저장/조회 서비스 (SharedPreferences + JSON)
class StarBattleStorageService {
  static const _keyCompletedGames = 'starbattle_completed_games';

  final SharedPreferences _prefs;

  StarBattleStorageService(this._prefs);

...
import 'star_battle_badge_definitions.dart';

/// 스타 배틀 배지 서비스 — 달성 평가 및 저장
class StarBattleBadgeService {
  static const _keyAcquiredBadges = 'starbattle_acquired_badges';
  final SharedPreferences _prefs;

  StarBattleBadgeService(this._prefs);
  ...
  List<BadgeDefinition> evaluateNewBadges(List<CompletedGameRecord> records) {
    ...
    for (final badge in starBattleBadgeDefinitions) {
  ...
  List<({BadgeDefinition badge, bool acquired})> getAllBadges() {
    final acquired = getAcquiredBadgeIds();
    return starBattleBadgeDefinitions

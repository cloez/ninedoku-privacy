...
class _YinYangHomeScreenState extends ConsumerState<YinYangHomeScreen> {
  ...
  void _showNewGameWarning(BuildContext context) {
    showKPDialog(
      context: context,
      title: AppStrings.get('yinyang.newGame.warning.title'),
      content: AppStrings.get('yinyang.newGame.warning.message'),
      confirmLabel: AppStrings.get('yinyang.newGame.warning.confirm'),

        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppStrings.get('yinyang.subtitle'),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(AppStrings.get('yinyang.newGame')),
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text(AppStrings.get('yinyang.dailyPuzzle')),
              ...
              Row(
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () => context.push(AppRoutes.statistics, extra: 'yinyang'),
                      icon: const Icon(Icons.bar_chart_rounded, size: 20),
                      label: Text(AppStrings.get('yinyang.statistics')),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () => context.push(AppRoutes.badges, extra: 'yinyang'),
                      icon: const Icon(Icons.emoji_events_rounded, size: 20),
                      label: Text(AppStrings.get('yinyang.badges')),
                    ),
                  ),
                ],
              ),
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    AppStrings.get('yinyang.continue'),
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                          fontWeight: FontWeight.bold,
                        ),
                  ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // 게임 소개
            Text(
              AppStrings.get('yinyang.about.title'),
              style: TextStyle(
                fontSize: 15,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            Text(
              AppStrings.get('yinyang.about.desc'),
              style: TextStyle(fontSize: 13, color: bodyColor, height: 1.5),
            ),
            const SizedBox(height: 16),
            // 규칙
            Text(
              AppStrings.get('yinyang.rules.title'),
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            _ruleRow('1', AppStrings.get('yinyang.rules.r1'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('2', AppStrings.get('yinyang.rules.r2'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('3', AppStrings.get('yinyang.rules.r3'), ruleColor),
          ],
        ),
      ),
    );

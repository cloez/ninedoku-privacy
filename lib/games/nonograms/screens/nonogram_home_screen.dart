        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppStrings.get('nonogram.subtitle'),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(AppStrings.get('nonogram.newGame')),
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text(AppStrings.get('nonogram.dailyPuzzle')),
              ...
              Row(
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () => context.push(AppRoutes.statistics, extra: 'nonogram'),
                      icon: const Icon(Icons.bar_chart_rounded, size: 20),
                      label: Text(AppStrings.get('nonogram.statistics')),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () => context.push(AppRoutes.badges, extra: 'nonogram'),
                      icon: const Icon(Icons.emoji_events_rounded, size: 20),
                      label: Text(AppStrings.get('nonogram.badges')),
                    ),
                  ),
                ],
              ),
  ...
  void _showNewGameWarning(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(AppStrings.get('nonogram.newGame.warning.title')),
        content: Text(AppStrings.get('nonogram.newGame.warning.message')),
        actions: [
          TextButton(
          ...
          TextButton(
            ...
            child: Text(AppStrings.get('nonogram.newGame.warning.confirm')),
          ),
        ],
      ),
    );
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    AppStrings.get('nonogram.continue'),
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                          fontWeight: FontWeight.bold,
                        ),
                  ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  _ChipLabel(
                    text: '${gameState.current.rows}x${gameState.current.cols}',
                    isDark: isDark,
                  ),
                ],
              ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // 게임 소개
            Text(
              AppStrings.get('nonogram.about.title'),
              style: TextStyle(
                fontSize: 15,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            Text(
              AppStrings.get('nonogram.about.desc'),
              style: TextStyle(fontSize: 13, color: bodyColor, height: 1.5),
            ),
            const SizedBox(height: 16),
            // 규칙
            Text(
              AppStrings.get('nonogram.rules.title'),
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            _ruleRow('1', AppStrings.get('nonogram.rules.r1'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('2', AppStrings.get('nonogram.rules.r2'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('3', AppStrings.get('nonogram.rules.r3'), ruleColor),
          ],
        ),
      ),
    );

          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppStrings.get('jigsawSudoku.subtitle'),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(AppStrings.get('jigsawSudoku.newGame')),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(AppStrings.get('jigsawSudoku.dailyPuzzle')),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text(AppStrings.get('jigsawSudoku.statistics')),
                      ),
                    ),
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text(AppStrings.get('jigsawSudoku.badges')),
                      ),
                    ),
                  ],
                ),
  ...
  void _showNewGameWarning(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(AppStrings.get('jigsawSudoku.newGame.warning.title')),
        content:
            Text(AppStrings.get('jigsawSudoku.newGame.warning.message')),
        actions: [
          TextButton(
          ...
          TextButton(
            ...
            child: Text(
                AppStrings.get('jigsawSudoku.newGame.warning.confirm')),
          ),
        ],
      ),
    );
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    AppStrings.get('jigsawSudoku.continue'),
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                          fontWeight: FontWeight.bold,
                        ),
                  ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  _ChipLabel(text: gameState.difficultyLabel, isDark: isDark),
                  const SizedBox(width: 8),
                  _ChipLabel(text: '9x9', isDark: isDark),
                ],
              ),
              const SizedBox(height: 12),
              ClipRRect(
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppStrings.get('jigsawSudoku.about.title'),
              style: TextStyle(
                fontSize: 15,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            Text(
              AppStrings.get('jigsawSudoku.about.desc'),
              style: TextStyle(fontSize: 13, color: bodyColor, height: 1.5),
            ),
            const SizedBox(height: 16),
            Text(
              AppStrings.get('jigsawSudoku.rules.title'),
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.bold,
                color: titleColor,
            ...
            const SizedBox(height: 8),
            _ruleRow('1', AppStrings.get('jigsawSudoku.rules.r1'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('2', AppStrings.get('jigsawSudoku.rules.r2'), ruleColor),
            const SizedBox(height: 6),
            _ruleRow('3', AppStrings.get('jigsawSudoku.rules.r3'), ruleColor),
          ],
        ),
      ),
    );

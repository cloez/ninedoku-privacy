...
/// 킬러 스도쿠 완료 기록 저장/조회 서비스
class KillerSudokuStorageService {
  static const _keyCompletedGames = 'killer_sudoku_completed_games';

  final SharedPreferences _prefs;

  KillerSudokuStorageService(this._prefs);
